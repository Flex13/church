      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="statement.php">Statement of Faith</a></li>
          </ul>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if ($page_title == 'Events') {
                                                echo "active";
        ...
        <li class="nav-item">
          <a class="nav-link <?php if ($page_title == 'Register') {
                                                echo "active";
                                            } ?>" href="register.php">Become a member</a>
        </li>
        <li class="nav-item">
...
=======
    <div id="logo"><a href="index.html">PFC Ministries</a></div>
  </div>
